...
#include <stylizer/pbr/gbuffer_data>
...
@group(0) @binding(7) var previous_packed_texture: texture_2d<f32>;
@group(0) @binding(8) var previous_packed_sampler: sampler;
...
fn ensure_gbuffer_fragment_layout() {
	...
	trash = textureSample(previous_packed_texture, previous_packed_sampler, vec2(0));
}