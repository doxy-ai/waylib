...
struct waylib_output_vertex {
	...
	@location(5) texcoords2: vec2f,
#ifdef WAYLIB_VERTEX_SUPPORTS_WIREFRAME
	@location(6) barycentric_coordinates: vec3f,
#endif
};

#ifdef WAYLIB_USE_DEFAULT_VERTEX_SHADER_AS_ENTRY_POINT
@vertex
fn waylib_default_vertex_shader(in: waylib_input_vertex, @builtin(instance_index) instance_index: u32, @builtin(vertex_index) vertex_index: u32) -> waylib_output_vertex
#else
fn waylib_default_vertex_shader(in: waylib_input_vertex, instance_index: u32, vertex_index: u32) -> waylib_output_vertex
#endif
{
